                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {applicants?.applications?.length > 0 ? (
                            ...
                            <div className="col-span-full py-12 text-center bg-white rounded-xl shadow-sm">
                                <p className="text-gray-500 text-lg">No applicants found for this position</p>
                            </div>
                        )}
                    </div>
                </div>
...
const ApplicantCard = ({ applicant }) => {
    ...
    return (
        <motion.div
            whileHover={{ y: -5 }}
            className="bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-200 hover:shadow-lg transition-all p-6 transform hover:scale-[1.02]"
        >
            ...
            <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h2 className="font-bold text-lg text-gray-800">{applicant.applicant?.fullname}</h2>
                    <p className="text-indigo-600 text-sm">{applicant.applicant?.email}</p>
                </div>
            </div>
            ...
            <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                <div className="flex gap-3">
                    <button
                        ...
                        className="px-4 py-2 bg-green-100 text-green-800 rounded-lg text-sm font-medium hover:bg-green-200 transition-colors flex items-center gap-2 shadow-sm"
                    >
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-red-100 text-red-800 rounded-lg text-sm font-medium hover:bg-red-200 transition-colors flex items-center gap-2 shadow-sm"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
