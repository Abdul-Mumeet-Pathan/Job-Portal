...
const Companies = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {filteredCompanies.length > 0 ? (
                                ...
                                <div className="col-span-full py-12 text-center bg-white/80 backdrop-blur-sm rounded-xl shadow-md">
            ...
            {/* Footer - outside the main content to avoid transparency */}
...
const CompanyCard = ({ company, navigate }) => (
    <motion.div
        whileHover={{ y: -5 }}
        className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md overflow-hidden border border-gray-200 hover:shadow-lg transition-all"
    >
        <div className="p-6">
            ...
            <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p className="text-blue-600 text-sm">{company.location}</p>
                </div>
            </div>
