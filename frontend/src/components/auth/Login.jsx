                        ...
                        <form onSubmit={submitHandler} className="p-6 space-y-6">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="focus:ring-2 focus:ring-blue-500 focus:border-blue-500 border-gray-300 rounded-lg"
                                />
                            </div>
                            ...
                            <div className="space-y-3">
                                <Label className="text-gray-700 font-medium block">Login as</Label>
                                <RadioGroup className="grid grid-cols-2 gap-3">
                                    <div className="flex items-center">
                                        ...
                                        />
                                        <Label htmlFor="student-role" className="ml-2 block text-sm font-medium text-gray-700 cursor-pointer">
                                            Student
                                        </Label>
                                    </div>
                                    <div className="flex items-center">
                                        <Input
                                            ...
                                            className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"
                                        />
                                        <Label htmlFor="recruiter-role" className="ml-2 block text-sm font-medium text-gray-700 cursor-pointer">
                                            Recruiter
                                        </Label>
                                    </div>
                                </RadioGroup>
